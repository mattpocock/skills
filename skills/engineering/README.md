...
- **[resolving-merge-conflicts](./resolving-merge-conflicts/SKILL.md)** — Resolve an in-progress merge or rebase by preserving the intent behind both sides, verifying the result, and finishing the Git operation.
