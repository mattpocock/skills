...
- **[codex-handoff](./codex-handoff/SKILL.md)** — Hand the current conversation to a fresh Codex task from Codex or Claude Code, preferring the app or official Claude plugin before CLI and document fallbacks. User-invoked.
